# source("Coursera/Exploratory Data Analysis/ExData_Plotting1/plot3.R")
...
png( filename = "Coursera/Exploratory Data Analysis/ExData_Plotting1/Plot3.png", width = 480, height = 480)
