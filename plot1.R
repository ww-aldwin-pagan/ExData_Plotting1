# source("Coursera/Exploratory Data Analysis/ExData_Plotting1/plot1.R")
...
# png( filename = "Coursera/Exploratory Data Analysis/ExData_Plotting1/Plot1.png", width = 480, height = 480)
